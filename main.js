...
function displatResults(res) {
    if (res.message == "Not Found") {
        ...
        document.querySelector('.container .button1').innerHTML = `<input type="button" class="btn1" style="background-color: black; color:white; cursor: pointer;" onclick="window.location.href= '${res.html_url}';" value="Visit GitHub profile" />
    `;
    }
}
